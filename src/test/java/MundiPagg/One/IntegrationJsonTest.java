...
public class IntegrationJsonTest {
    ...
    public void TestA_CreateSale() {
        ...
        CreditCard creditCard = new CreditCard(CreditCardBrandEnum.Visa,
										       "4111111111111111",
										       10,
										       2018,
										       "Comprador da S",
        ...
        CreditCardTransaction creditCardTransaction = new CreditCardTransaction(92000L, creditCard, null, 1, null, new CreditCardTransactionOptions(), null, null);
